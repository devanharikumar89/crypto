...
public class  Receiver{
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  TimeUnit.SECONDS.sleep(5);
        ...
        boolean result = dlc.verify(comm, deComm);
        pedersenSummary.put(++mapIndex, result);
    ...
    System.out.println("Pedersen Commitment Verification Summary : ");
    for(int a : pedersenSummary.keySet()){
        System.out.println(a+" : "+pedersenSummary.get(a));
    }
}
}
