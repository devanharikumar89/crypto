...
public class  Receiver{
    ...
    public static void main(String[] args) throws Exception {
       ...
       //while(gh-->0){
        ...
        //System.out.println("1   "+deCommString);
        ...
        //System.out.println("1  "+deCommitments[i+1]);
        //System.out.println("2  "+mStrings[i+1]);
        //System.out.println("3  "+rStrings[i+1]);

        BigInteger deComm = new BigInteger(deCommitments[i+1]);
