...
public class Committer{
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        byte[]messageBytes = in.getBytes();
        ZpElement messageElement = (ZpElement)dlc.dlog.encodeByteArrayToGroupElement(messageBytes);
        BigInteger m = messageElement.getElementValue();
        System.out.println("\n\nMessage in Field : "+m);
